#include <atom_TGS_Gas_Sensors.h>
#include <std_msgs/UInt16.h>

std_msgs::UInt16 tgs_gas_analog_msg;
std_msgs::UInt16 tgs_gas_digital_msg;
ros::Publisher tgs_gas_analog_pub("tgs_2602_analog", &tgs_gas_analog_msg);
ros::Publisher tgs_gas_digital_pub("tgs_2602_digital", &tgs_gas_digital_msg);

void setup()
{
  setupM5stackROS("M5Stack ROS TGS2602_Gas_Sensor");
  setupTGSSensors();

...
ros::Publisher tgs_gas_analog_pub("tgs_2600_analog", &tgs_gas_analog_msg);
ros::Publisher tgs_gas_digital_pub("tgs_2600_digital", &tgs_gas_digital_msg);

void setup()
{
  setupM5stackROS("M5Stack ROS TGS2600_Gas_Sensor");
  setupTGSSensors();

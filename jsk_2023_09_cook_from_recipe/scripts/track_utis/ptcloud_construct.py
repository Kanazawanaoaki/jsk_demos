...
def create_colored_point_cloud(rgb_image, depth_image, mask_image, cam_file, use_mask=True, extract_mask=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rgb_file_path', '-r', type=str, help='Input directory containing subdirectories with files', default='../../datas/object_datas/data_20240514_test_03_for_train/rgb/1716536261013376474.png')
    parser.add_argument('--use_mask', '-m', action='store_true', help='use approixmate.')
    ...
    colored_point_cloud = create_colored_point_cloud(rgb_file_path, depth_file_path, mask_file_path, cam_file_path, use_mask=args.use_mask)
    # 点群を表示

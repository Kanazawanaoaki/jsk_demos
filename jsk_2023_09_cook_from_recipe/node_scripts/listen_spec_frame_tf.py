...
def main():
    parser = argparse.ArgumentParser(description="Calculate transformed coordinates between two frames")
    # parser.add_argument('--parent_frame', '-p', type=str, default='head_mount_kinect_rgb_optical_frame', help="Name of the parent frame")
    # parser.add_argument('--child_frame', '-c', type=str, default='r_gripper_tool_frame', help="Name of the child frame")
    parser.add_argument('--parent_frame', '-p', type=str, default='r_gripper_tool_frame', help="Name of the parent frame")
    parser.add_argument('--child_frame', '-c', type=str, default='r_gripper_r_finger_tip_link', help="Name of the child frame")

    rospy.init_node('listen_spec_tf')

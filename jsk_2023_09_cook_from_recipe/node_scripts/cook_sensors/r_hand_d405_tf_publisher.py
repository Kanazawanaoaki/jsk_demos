...
def broadcast_tf():
    ...
    while not rospy.is_shutdown():
        ...
        ## キャリブ v4  マウンタを変えて，待機姿勢でcheckerboardでキャリブ
        translation = (0.105835, -0.019293, -0.049296)  # 例えば、x、y、zは適切な値に置き換える必要があります
        rotation = (0.993213, -0.005913, 0.1155, 0.01233)  # 回転の場合も同様です

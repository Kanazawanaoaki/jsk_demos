...
class RectAddedImagePublisher():
    def __init__(self):
        ...
        self.input_topic = rospy.get_param('~input', "/femto_mega/color/image_raw")

        # Initialize ros params
        self.offset_x = rospy.get_param('~offset_x', 570)
        self.offset_y = rospy.get_param('~offset_y', 240)
        self.width = rospy.get_param('~width', 140)
        self.height = rospy.get_param('~height', 140)
    ...
    def image_cb(self, msg):
        ...
        recet_added_pub_msg = self.bridge.cv2_to_imgmsg(rect_added_img, "rgb8")
        ...
        cropped_pub_msg = self.bridge.cv2_to_imgmsg(cropped_img, "rgb8")

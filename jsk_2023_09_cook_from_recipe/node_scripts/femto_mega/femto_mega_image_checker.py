...
class ImageSubscriber:
    def __init__(self):
        rospy.init_node('femto_mega_image_subscriber_node', anonymous=True)
    ...
    def image_callback(self, msg):
        ...
        if self.no_topic_flag or self.once_topic_flag==False:
            ...
            self.say_something("Femto_Mega image topic is arrive.")
    ...
    def check_timeout(self):
        ...
        if time.time() - self.last_image_time > self.timeout_threshold:
            if self.no_topic_flag:
                ...
                self.say_something("I haven't seen the femto_mega image topic for {} seconds.".format(self.timeout_threshold))
        # else:
        #     if self.no_topic_flag:
        #         self.no_topic_flag = False
        #         self.say_something("Femto_Mega image topic is arrive.")
